  ...
  return (
    <section id="about" className="relative pt-32 px-6 md:px-12 lg:px-20 max-w-screen-2xl mx-auto min-h-screen flex flex-col lg:flex-row items-center justify-between gap-12">
      ...
      <div className="flex-1 relative self-stretch flex items-end justify-center lg:justify-end mt-12 lg:mt-0 min-h-[400px]">
        ...
        {/* Black Circle "Hello" */}
        <div className="absolute left-0 bottom-1/3 w-32 h-32 bg-black rounded-full flex items-center justify-center text-white font-bold text-xl z-20 shadow-xl border-4 border-white hidden md:flex">
          Hello
        </div>

        {/* Squiggle */}
        <svg className="absolute bottom-0 right-0 w-24 h-24 text-black z-20" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="8">
